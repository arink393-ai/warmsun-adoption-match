...
## 6.11 第二階段結構化問診 S2-01～S2-05（先掛著，enabled=false）

六條規則（S2-04 拆成節奏與「會不會說一聲」兩條）已經進庫，全部 `enabled = false`。
...
第二階段的結構化表單本身。48 題不會全部結構化——只有真的會餵給規則引擎的題目才需要，
其餘繼續保留自由回答，不然認養面談會變成一份超長的人格測驗。
